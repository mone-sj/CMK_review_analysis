...
p.add_argument('--model_load_path', default='./classify/point_classify/', type=str)
...
print(f'point_device: {torch.cuda.current_device()}')
...
def point_predict(predict_sentence):
